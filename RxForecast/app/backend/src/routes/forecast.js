...
router.get('/:storeId/:ndc', (req, res) => {
  ...
  res.json({
    ...
    inventory,
    citations: [
      { type: 'dispense_history', detail: `${forecast.dataPoints || 0} dispense events over ${forecast.dataWindowDays || 0} days`, source: 'RxForecast_SyntheticData/dispense_history.csv' },
